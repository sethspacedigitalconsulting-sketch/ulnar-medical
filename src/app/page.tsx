...
// Heavy animation components — lazy loaded only when scrolled into view
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {services.map((svc) => (
            <div
              ...
              className={`p-8 rounded-2xl border bg-[#080f1e]/40 backdrop-blur-md cursor-pointer transition-all duration-300 select-none text-left ${expandedCard === svc.id
                ? 'border-[#F4B9B9] shadow-lg shadow-black/40'
